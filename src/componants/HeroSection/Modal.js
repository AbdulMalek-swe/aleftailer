  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50  ">
      <div className="bg-white p-6 rounded-lg relative lg:w-1/3 sm:w-1/2 w-11/12 font-arial ">
        ...
        <p className='lg:text-xl sm:text-base text-sm text-center text-black mb-7 uppercase'> {t('modal.offer1')} <span className='text-red000'> {t('modal.offer2')}</span> {t('modal.offer3')}  </p>
        <div className='flex justify-center mb-7'>
          <div className=''>
            ...
            <div className='flex justify-around'>
              <button className='bg-black text-white rounded text-sm py-3 px-5'>{t('modal.nothanks')}</button>
              <button className='bg-black text-white rounded text-sm py-3 px-10' onClick={()=>subscribe()} type='submit'>  {t('modal.enter')}</button>
            </div>
          </div>
        </div>
        <div>
