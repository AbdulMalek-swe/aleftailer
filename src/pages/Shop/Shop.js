    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar>
          ...
          <div className='grid grid-cols-2 items-center place-content-center w-full'>
        ...
        <div className='mt-36'>
          ...
          <div className='grid xl:grid-cols-4 lg:grid-cols-3  md:grid-cols-2 grid-cols-1 lg:gap-8 gap-4 mt-5'  >
            {product.sort(sortingFunction).map(item =>
              ...
              <div className='shadow-md hover:shadow-lg duration-300 h-fit rounded-md border border-gray-400/30 relative text-black dark:text-white    mx-2  ' key={item._id}>
                ...
                <div className='  mb-5 font-arial  text-base font-bold  px-5'>
