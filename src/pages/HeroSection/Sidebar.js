  ...
  return (
    <div className="relative z-10">
      <button
        ...
        className={`fixed top-0 left-0 w-12 h-12 text-white  bg-black text-white  rounded-br-md   z-10 focus:outline-none ${isOpen ? 'hidden' : ''
          }`}
      >
        <DoubleArrowIcon />
      </button>
      ...
      >
        <div className="p-4 flex justify-end">
          <button
            onClick={toggleSidebar}
            className="text-sideCross focus:outline-none"
          >
            <svg
