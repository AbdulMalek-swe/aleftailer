    ...
    return (
        <div  >
            ...
            <div className='container-sk'>
                ...
                <div className='my-7'>
                    <img src={inside.image[1]} alt='loading...' className=' w-full lg:h-80 md:h-52 sm:h-44 h-40' />
                </div>
    ...
    return (
        <div className='grid md:grid-cols-2 grid-cols-1 items-center gap-y-6   gap-x-6'>
            <div className='border-black border-2'>
                <div className='h-1/2'>
             <img src={inside?.image[0]} alt='loading...' className='w-full lg:h-80 md:h-96 sm:h-52 h-40' />
                </div>
            </div>
    ...
    return (
        <div className='  grid md:grid-cols-2 grid-cols-1 items-center gap-6 md:gap-y-0 '>
            <div className='my-auto'>
                <img src={inside?.image[2]} alt='loading...' className='  w-full lg:h-80 md:h-52 sm:h-44 h-40' />
            </div>
