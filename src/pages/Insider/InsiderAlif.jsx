    ...
    return (
        <div  >
           ...
           <Handemade  inside={inside} />
             <div className='my-7'>
                <img src={inside.image[0]} alt='loading...' className='w-full' />
            </div>
    ...
    return (
        <div className='grid md:grid-cols-2 grid-cols-1 items-center gap-y-6 md:gap-y-0'>
            <div className='my-auto'>
                <img src={inside?.image[1]} alt='loading...' className='w-full h-full my-auto' />
            </div>
            <div className='bg-[#F0F0F0] h-full flex flex-col justify-center rounded-tl-[100px] rounded-br-[100px] -mt-2 -ml-1  md:p-0 p-7'>
                <h1 className='font-sans font-semibold text-3xl mb-5 mx-5'> {inside.title3}</h1>
