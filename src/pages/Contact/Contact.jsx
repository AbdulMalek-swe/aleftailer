...
import img from 'assets/image/map alef atelier.png'
        ...
        <div className='bg-contact bg-cover bg-no-repeat '>
            <div className='container-sk pt-52 pb-20'>
               ...
               onChange={handleMessage}
                    ...
                    <div className='grid grid-cols-3 justify-center   text-white mt-7  '>
                        <div className='col-span-2 grid grid-cols-2 gap-6'>
                            <div className='font-normal text-white text-center'>
                                <h1 className='font-semibold text-xl mb-7'>Contact Us</h1>
                            ...
                            <div className='font-normal text-white text-center'>
                                ...
                                <h1 className='font-semibold text-xl mb-7'>ADDRESS</h1>
                                <p className='mb-7 text-xs'>Greece, Athens, Kolokotroni 9,
                                    Chalandri 152 33</p>
                                <div className='flex  justify-center gap-x-2'>
                            ...
                            <div className='font-normal text-white text-center'>
                                ...
                                <h1 className='font-semibold text-xl mb-7'>MAIL</h1>
                            ...
                            <div className='font-normal text-white text-center'>
                                ...
                                <h1 className='font-semibold text-xl mb-7'>CALL US</h1>
                        ...
                        <div className=' flex items-center justify-center'>
                            <div className='font-normal text-white text-center'>
                                ...
                                <h1 className='font-semibold text-xl mb-7'> SCHEDULE</h1>
